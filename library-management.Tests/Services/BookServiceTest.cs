...
public class BookServiceTest
{
    ...
    public void Should_return_all_books_()
    {
        ...
        {
            new BookResponseDto {Id = 1, Title = "Book One", Author = "Author A", Quantity = 5, Description = "Description One", ImageUrl = "image1.jpg", PublishYear = 2020, Genres = new List<GenreResponseDto>()},
            new BookResponseDto {Id = 2, Title = "Book Two", Author = "Author B", Quantity = 0, Description = "Description Two", ImageUrl = "image2.jpg", PublishYear = 2021, Genres = new List<GenreResponseDto>()}
        };
    ...
    {
        var book = new BookResponseDto { Id = 1, Title = "Book One", Author = "Author A", Quantity = 5, Description = "Description One", ImageUrl = "image1.jpg", PublishYear = 2020, Genres = new List<GenreResponseDto>() };
    ...
    public async Task Create_ValidRequest_ReturnsBookResponseDto()
    {
        ...
        // Mock do gênero
        genreRepositoryMock.Setup(g => g.GetById(1))
            .Returns(new GenreResponseDto { Id = 1, Name = "Fiction" });

        // Mock do upload da imagem
        uploadFileServiceMock.Setup(u => u.UploadFileAsync(It.IsAny<IFormFile>()))
            .ReturnsAsync("https://fakeurl.com/image.png");

        // Mock do repository Create
        bookRepositoryMock.Setup(b => b.Create(It.IsAny<BookInsertDto>()))
            .Returns(new BookResponseDto
            {
                ...
                Genres = new List<GenreResponseDto> { new GenreResponseDto { Id = 1, Name = "Fiction" } },
    ...
    public async Task Update_ExistingBook_ReturnsUpdatedBookResponseDto()
    {
        ...
        bookRepositoryMock.Setup(repo => repo.Update(1, It.IsAny<BookUpdateDto>()))
                .Returns(new BookResponseDto
                {
                    Id = 1,
                    Title = "Updated Book",
