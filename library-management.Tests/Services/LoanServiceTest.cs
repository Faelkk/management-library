...
public class LoanServiceTest
{
    ...
    public void should_return_all_loans()
    {
        ...
        {
            new LoanResponseDto {Id = 1, BookId = 1, UserId = 1, LoanDate = DateTime.Now, ReturnedAt = null, ReturnDate = DateTime.Now.AddDays(7)},
            new LoanResponseDto {Id = 2, BookId = 2, UserId = 2, LoanDate = DateTime.Now, ReturnedAt = null, ReturnDate = DateTime.Now.AddDays(7)}
        };
    ...
    {
        var loan = new LoanResponseDto { Id = 1, BookId = 1, UserId = 1, LoanDate = DateTime.Now, ReturnedAt = null, ReturnDate = DateTime.Now.AddDays(7) };
    ...
    {
        var loanInsertDto = new LoanInsertDto { BookId = 1, UserId = 1 };
        ...
        userRepositoryMock.Setup(repo => repo.GetById(1)).Returns(user);

        loanRepositoryMock.Setup(repo => repo.Create(It.IsAny<LoanInsertDto>())).Returns(new LoanResponseDto
        {
            Id = 1,
            BookId = 1,
            UserId = 1,
